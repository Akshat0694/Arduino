...
const float Vin = 5.0;
const double A = 0.008395; // constant A, B and C from Steinhart–Hart equation
const double B = 0.00025942;
const double C = 0.00000016082;
...
double Thermister(int RawADC) { //Best place to put the function: before or after setup()? TBA. 
  ...
  Temp1 = (1 / (A + (B * log(Runknown1)) + (C * pow(log(Runknown1),3)))) - 273.15;
  //Temp2 = (1 / (A + (B * log(Runknown2)) + (C * pow(log(Runknown2),3)))) - 273.15;
